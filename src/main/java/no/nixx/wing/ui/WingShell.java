...
import no.nixx.wing.pipeline.ParseException;
import no.nixx.wing.pipeline.PipelineParser;
import no.nixx.wing.pipeline.model.Pipeline;
import no.nixx.wing.ui.components.LabelOutputStream;
...
public class WingShell extends VBox {
...
//        this.setBackground(new Background(new BackgroundFill(Color.RED, null, null)));
    ...
    private void undecorate(Region region) {
        ...
        if (region instanceof ScrollPane) {
            ...
            final URL stylesheetURL = WingShell.class.getResource("/style.css");
